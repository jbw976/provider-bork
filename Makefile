...
IMAGES = provider-bork
-include build/makelib/imagelight.mk

# ====================================================================================
# Setup XPKG

XPKG_REG_ORGS ?= ghcr.io/jbw976
# NOTE(hasheddan): skip promoting on ghcr.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= ghcr.io/jbw976
XPKGS = provider-bork
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-bork: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Bork CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Bork controllers
...
# This target prepares repo for your provider by replacing all "bork"
